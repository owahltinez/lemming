...
class TestLemmingRun(unittest.TestCase):
    ...
    def test_run_success(self, mock_popen):
        ...
        mock_process.poll.side_effect = [None, 0] # First poll None (running), second poll 0 (finished)
    ...
    def test_run_command_not_found(self, mock_popen):
        mock_popen.side_effect = FileNotFoundError(2, "No such file or directory", "gemini")
